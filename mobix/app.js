...
const data = [
  {
    ...
    rating: 4,
    // brand: "samsung",
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-4066_1-7c806119.webp",
    storage: [
    ...
    rating: 5,
    // brand: "apple",
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3743_1.webp",
    storage: [
  ...
  { size: "1TB", price: 4599 }
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/e4Cxid7tGGUL96IMpKSRQ8oqcuA5qqHdDSB7EVxe-full.jpg",
    storage: [
    { size: "", price: 68 }
    ...
    rating: 5,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-kot-1114-nb-3219_1.webp",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3432_1.png",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-tbq-1105-tb-0777_1.png",
    storage: [
    ...
    rating:3.5, 
    image: "http://127.0.0.1:5500/mobix/img/Ca8hUZOJH7BeIAkaZVCoNi2iTvAoGfZdbpdjdeaU-full.jpg",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3661_1.webp",
    storage: [
    ...
    rating: 5,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-2476_12.png",
    storage: [
    ...
    rating: 3.5,
    image: "http://127.0.0.1:5500/mobix/img/6145_11.jpg",
    storage: [
      { size: "", price: 399 }
    ]
  ...
  },
   {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-bp-0225-01.png",
    storage: [
      { size: "2GB", price: 130 }
    ]
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3697_1.webp",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-2892_1.png",
    storage: [
  ...
  
  {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3595_10.png",
    storage: [
  ...
  },  
   {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1109-tw-0831_1.png",
    storage: [
      {  price: 159.99}
    ]
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/_1000_-__1.jpg",
    storage: [
        { price: 3 }
  ...
  },  
   {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-smw-1106-sw-0327_111_1.png",
    storage: [
      {  price: 639 },
    ...
    rating: 4.5,
    image: "http://127.0.0.1:5500/mobix/img/t5J3Xl52RbAWBz9YrRN8h6I8lipGGdglz0nlsY37-full.jpg",
    storage: [
       { size: "", price: 800 }
    ]
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1267-pt-0585_3333.png",
    storage: [
      { price: 8.99 }
    ]
...

   {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1267-kt-2439_1.png",
    storage: [
      {price: 75 }
    ]
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3854_1.png",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3639_1.png",
    storage: [
...

  {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1109-tw-0883_1-8e99f1cf.webp",
    storage: [
      { price: 69.99 }
    ]
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3867_1.png",
    storage: [
      { size: "128GB", price: 419 },
  ...
  
  {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1267-kt-2540_1.png",
    storage: [
      { price: 139 }
    ]
  }, 
  
   {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1267-kt-2230_1_1.png",
    storage: [
      { price: 49.99 }
    ]
  ...
  
  {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1267-kt-2589_1.png",
    storage: [
      { price: 94.99 }
    ]
  ...
  
  {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1267-kt-2371.png",
    storage: [
      {  price: 94 }
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3573_1.webp",
    storage: [
...

   {
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3640_.png",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-sbp-1105-sm-3852_1.png",
    storage: [
    ...
    rating: 4,
    image: "http://127.0.0.1:5500/mobix/img/tm-dg-acs-1109-ap-0424_1-103525e9.webp",
    storage: [
      {price: 69.99 }
    ]
